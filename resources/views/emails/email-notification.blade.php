    ...
    <table class="main" width="100%">
        ...
        <tr>
            <td class="header" align="center">
                <img src="https://elitecarparking.es/wp-content/uploads/2024/08/ELITE-CAR-PARKING-1-107x107.png" alt="Elite Car Parking Logo" width="100">
                    ...
                    <tr>
                        <td class="important-info">
                            ...
                            <ul>
                                ...
                                <li>There is a 15-minute free parking period enforced by Airport Authorities.</li>
                            </ul>
                        </td>
                    </tr>
                </table>
                ...
                <table width="100%" style="margin-top: 20px;">
                    <tr>
                        <td class="booking-details">
                            ...
                            <p><strong>Vehicle Details:</strong> {{ $booking->vehicle_color }} {{ $booking->vehicle_model }} ({{ $booking->vehicle_number }})</p>

                            @if($booking->has_arrival_booking == 'Yes')
                                <p><strong>Arrival Flight:</strong> {{ $booking->arrival_mode }} on {{ $booking->arrival_datetime->format('D jS M Y H:i') }}</p>
                            @endif

                            <p><strong>Hold Luggage:</strong> {{ $booking->has_hold_luggage }}</p>

                            @if($booking->has_departure_booking == 'Yes')
                                <p><strong>Departure Meeting Time:</strong> {{ $booking->departure_meeting_time->format('D jS M Y H:i') }} at Departures</p>
                            @endif
                    ...
                    <tr>
                        <td>
                            ...
                            <ul>
                                ...
                                <li>Our responsibility begins upon in-person transfer of the vehicle at departures.</li>
                                <li>A contract/invoice must be signed by both parties to commence responsibility.</li>
                                <li>We are not liable for items left in the vehicle unless registered on the contract.</li>
                                <li>We are responsible for safe transportation and storage but not for technical/mechanical issues.</li>
                                <li>Vehicle status checks are performed at collection; please verify upon return.</li>
                                ...
                                <li>Unclaimed vehicles will incur additional fees as per the current price list.</li>
                                <li>Payment in Euros is required for vehicle release.</li>
                            </ul>
                            <p>For full terms and conditions, please visit our website or contact our customer service.</p>
                        </td>
                    </tr>
                </table>
            </td>
